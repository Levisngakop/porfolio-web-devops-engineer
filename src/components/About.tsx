    ...
    <section id="about" className="py-20 px-6 bg-slate-800 text-slate-200">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="bg-slate-700 rounded-2xl p-6 md:p-8 shadow-lg shadow-blue-500/20 mb-6">
          <h3 className="text-white text-xl md:text-2xl font-semibold mb-2 flex items-center justify-center">
            <Clock className="w-5 h-5 mr-2 text-white" /> The Beginning
          </h3>
        ...
        <div className="bg-slate-700 rounded-2xl p-6 md:p-8 shadow-lg shadow-blue-500/20 mb-6">
          <h3 className="text-white text-xl md:text-2xl font-semibold mb-2 flex items-center justify-center">
            <Target className="w-5 h-5 mr-2 text-white" /> The Growth
          </h3>
          <p className="text-slate-300 text-base leading-relaxed text-center">
        ...
        <div className="bg-slate-700 rounded-2xl p-6 md:p-8 shadow-lg shadow-blue-500/20 mb-6">
          <h3 className="text-white text-xl md:text-2xl font-semibold mb-2 flex items-center justify-center">
            <CheckCircle className="w-5 h-5 mr-2 text-white" /> The Impact
          </h3>
          <p className="text-slate-300 text-base leading-relaxed text-center">
