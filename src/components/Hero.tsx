...
const Hero: React.FC = () => {
  return (
    <section id="hero" className="pt-20 pb-8 px-6 bg-slate-900 text-slate-200">
      <div className="container mx-auto max-w-5xl flex flex-col md:flex-row items-center justify-center md:justify-between">
        {/* Text content */}
        <div className="text-center md:text-left md:max-w-xl">
          <h1 className="text-5xl md:text-6xl font-extrabold mb-4 text-white">
            Levis Ngakop
          </h1>
          <h2 className="text-2xl md:text-3xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 mb-2">
